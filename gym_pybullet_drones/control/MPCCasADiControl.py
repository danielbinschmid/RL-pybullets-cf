...
class MPCCasADiControl(BaseControl):
    ...
    def __init__(self,
        ...
        for k in range(Nhoriz - 1):
            ...
            # The general behavior of this is that it is less optimal

            Q_k = k * 2.0 / Nhoriz * Q
            R_k = k * 2.0 / Nhoriz * R
            # Performs a bit better than some other adaptive k-weighting matrices approaches
            # First track performance: 3.875
            # But overall it is not optimal
