...
def vis():
    traj_rl = load_from_path("/shared/d/master/ws23/UAV-lab/git_repos/RL-pybullets-cf/runnables/test_suite/logs/pos_logs_rl_traj")
    traj_pid = load_from_path("/shared/d/master/ws23/UAV-lab/git_repos/RL-pybullets-cf/runnables/test_suite/logs/pos_logs_pid_traj")
    ...
    vis_discr_traj(trajs, t_traj, plotname="traj_following.pdf")
