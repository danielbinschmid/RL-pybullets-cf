...
from trajectories.discretized_trajectory import DiscretizedTrajectoryFromWaypoints
...
def plot_drone_actual_trajectory():
    


if __name__ == "__main__":
    traj = DiscretizedTrajectoryFromWaypoints(CubeTrajectory().waypoints)
    vis_discr_traj(traj, CubeTrajectory().waypoints)
    print("Plot saved to minimum_snap_poly_traj.pdf")
    print("Done")
