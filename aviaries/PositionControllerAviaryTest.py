...
class PositionControllerAviaryTest(BaseRLAviary):
    ...
    def __init__(
        ...
        self.TARGET_POS = target_trajectory[self.cur_idx].coordinate
    ...
    def _computeReward(self):
        ...
        if np.linalg.norm(self.TARGET_POS - state[0:3]) < 0.05:
            ...
            if self.cur_idx == len(self.TARGET_TRAJECTORY):
                self.done = True
            else:
                self.TARGET_POS = self.TARGET_TRAJECTORY[self.cur_idx].coordinate
        return ret
